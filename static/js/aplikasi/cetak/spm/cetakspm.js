    ...
    if (typeof myTable == 'undefined') {
        myTable = $('#cetakspdtable').dataTable({
            ...
            "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull, oSettings) {
                ...
                var buttonnamattd = aData['status'] == 'PENGAJUAN' ? '<a  onclick="tampilcek(' + aData['id'] + ')" class="fancybox fancybox.iframe btn dark" href="' + getbasepath() + '/common/listpejabatppkd/' + aData['id'] + '/SPM/' + aData['nilaiSpp'] + '?target=top" title="Pilih PejabatPPKD"  ><i class="icon-zoom-in"></i></a>' : " ";
