...
$config['tables']['groups'] = 'karir.groups';
$config['tables']['users'] = 'karir.users';
$config['tables']['meta'] = '';
 ...
 */
$config['site_title']                 = "Sistem Informasi Eksekutif";       // Site Title, example.com
$config['admin_email']                = "harsap@gmail.com"; // Admin Email, admin@example.com
