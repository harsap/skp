...
class Ion_auth {
    ...
    public function get_data_user_by_id($id = false) {
        return $this->ion_auth_model->get_user_by_id($id)->row();
    }

    public function get_user_name_all($id = false) {
        return $this->ion_auth_model->get_user_nameall($id);
    }

    public function is_group_by_id($check_group) {
        $user_group = $this->ci->session->userdata('group_id');
