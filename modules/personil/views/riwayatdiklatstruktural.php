<ul class="page-breadcrumb breadcrumb">
    ...
    <li><a href="#">Riwayat Diklat Struktural <?php echo $peg->peg_nama; ?></a></li>
</ul>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <thead>
                    <tr align="center">
                        ...
                        <th colspan="2" width="20%">Diklat Struktural</th>
                        <th colspan="2" width="20%">Tanggal</th>
                        <th rowspan="2" width="17%">Instansi Penyelenggara</th>
                        <th rowspan="2" width="10%">Tempat</th>
                        <th rowspan="2" width="5%">Jumlah Jam</th>
                        <th colspan="3" width="15%">STTP</th> 
                    </tr>
                    <tr align="center">
                        <th width="10%">Nama</th>
                    ...
                    foreach ($pendfor as $item) {
                        ...
                        <tr id="baris<?php echo $i; ?>">
                            <td align="center">
                                ...
                                <input type='hidden' name='kategori_id<?php echo $i; ?>' id='kategori_id<?php echo $i; ?>'
                                       value='<?php echo $item->kategori_id; ?>'/>
                                <input type='hidden' name='kategori_parentid<?php echo $i; ?>'
                                       id='kategori_parentid<?php echo $i; ?>' value='<?php echo $item->kategori_parent; ?>'/>

                            </td>
                            <td><?php echo $item->kategori_nama; ?></td>
                            <td><?php echo $item->parent_nama; ?></td>
                            ...
                            <td><span
                                    id='span_diklat_penyelenggara<?php echo $i; ?>'><?php echo $item->diklat_penyelenggara; ?></span>
                            ...
                            <td><input type='hidden' name='diklat_tempat<?php echo $i; ?>' id='diklat_tempat<?php echo $i; ?>'
                                       value='<?php echo $item->diklat_tempat; ?>'/>
                                <span id='span_diklat_tempat<?php echo $i; ?>'><?php echo $item->diklat_tempat ?></span>
                            </td>
                            <td><input type='hidden' name='diklat_jumlah_jam<?php echo $i; ?>'
                            ...
                            <td><input type='hidden' name='diklat_sttp_no<?php echo $i; ?>' id='diklat_sttp_no<?php echo $i; ?>'
                                       value='<?php echo $item->diklat_sttp_no; ?>'/>
                                <span id='span_diklat_sttp_no<?php echo $i; ?>'><?php echo $item->diklat_sttp_no; ?></span></td>
                            <td align="center">
                                <input type='hidden' name='diklat_sttp_tgl<?php echo $i; ?>' id='diklat_sttp_tgl<?php echo $i; ?>'
                                       ...
                                       <?php echo(isset($item->diklat_sttp_tgl) && $item->diklat_sttp_tgl != '' ? strftime("%d-%m-%Y", strtotime($item->diklat_sttp_tgl)) : ''); ?>
                            </td>
                            <td><input type='hidden' name='diklat_sttp_pej<?php echo $i; ?>' id='diklat_sttp_pej<?php echo $i; ?>'
                                       value='<?php echo $item->diklat_sttp_pej; ?>'/>
                                <span id='span_diklat_sttp_pej<?php echo $i; ?>'><?php echo $item->diklat_sttp_pej; ?></span></td>
