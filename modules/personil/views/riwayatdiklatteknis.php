<ul class="page-breadcrumb breadcrumb">
    ...
    <li><a href="#">Riwayat Diklat Teknis <?php echo $peg->peg_nama; ?></a></li>
</ul>
                    ...
                    foreach ($pendfor as $item) {
                        ...
                        <tr id="baris<?php echo $i; ?>">
                            ...
                            <td>
                                ...
                                <input type='hidden' name='diklat_teknis_id<?php echo $i; ?>' id='diklat_teknis_id<?php echo $i; ?>'
                                       value='<?php echo $item->diklat_teknis_id; ?>'/>
                                <input type='hidden' name='diklat_teknis_nm<?php echo $i; ?>' id='diklat_teknis_nm<?php echo $i; ?>'
                                       value='<?php echo $item->diklat_teknis_nm; ?>'/>
                                <span id='span_diklat_teknis_nm<?php echo $i; ?>'><?php echo $item->diklat_teknis_nm; ?></span>
                            </td>
                            <td align="center">
